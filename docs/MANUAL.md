...
| Setting | Default | Description |
|---|---|---|
| Enable Daily Notes | off | Allows the plugin to write watched / watchlist / favorite / rating events into existing Daily Note files. Missing Daily Note files are never created. |
